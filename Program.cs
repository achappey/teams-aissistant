...
builder.Services.AddSingleton(sp => new OpenAIClient(config.OpenAI.ApiKey));
...
builder.Services.AddTransient<IBot>(sp =>
{
    ...
    var handlers = sp.GetRequiredService<ActivityHandlers>();

    app.OnMessage("/reset", ActivityHandlers.ResetMessageHandler);
    app.OnMessage("/files", handlers.SourcesMessageHandler);
    app.OnMessage("/assistant", handlers.AssistantMessageHandler);
